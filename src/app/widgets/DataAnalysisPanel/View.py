...
class DataAnalysisView(QWidget):
    ...
    def create_adc_analysis_options(self):
        ...
        self.adc_roi_start.setSingleStep(0.01)
        self.adc_roi_start.setDecimals(2)
        ...
        self.adc_roi_mid.setSingleStep(0.01)
        self.adc_roi_mid.setDecimals(2)
        ...
        self.adc_roi_end.setSingleStep(0.01)
        self.adc_roi_end.setDecimals(2)
